 ...
 * with the Glass HUD overlaid on top (header status/switcher, left info zone,
...
export function HomeScreen() {
  ...
  return (
    <AppShell
      ...
      right={<HudRightPanel />}
      centerChat={
        <GlassChatPanel online={connection === 'online'} messages={messages} pending={pending} onSend={send} />
      }
    >
